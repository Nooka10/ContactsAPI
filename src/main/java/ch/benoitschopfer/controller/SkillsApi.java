...
public interface SkillsApi {
   ...
   */
  @ApiOperation(
    value = "Adds a new skill.",
    nickname = "addSkill",
    notes = "Adds a new skill to the system. The connected user must be an admin.",
   ...
   */
  @ApiOperation(
    value = "Delete an existing skill.",
    nickname = "deleteSkill",
    notes = "Delete an existing skill. The connected user must be an admin.",
    authorizations = {
      @Authorization(value = "bearer", scopes = {
        @AuthorizationScope(scope = "admin", description = "Grants read and write access to anything (his/others contacts and their skills, skills, users).")
      })
   ...
   */
  @ApiOperation(
    value = "Get skill by name.",
    nickname = "getSkill",
    notes = "Returns the skill corresponding to the received name.",
    response = Skill.class,
    authorizations = {
      @Authorization(value = "bearer", scopes = {
   ...
   */
  @ApiOperation(
    value = "Get all skills",
    nickname = "getSkills",
    notes = "Returns all skills whose name contains the received string.",
    response = Skill.class,
  ...
  @PreAuthorize("hasAnyRole('ADMIN', 'USER')")
  default ResponseEntity<Page<Skill>> getSkills(
    @ApiParam(value = "Returns all skills whose name contains the received string.") @Valid @RequestParam(value = "name", required = false) String name,
    Pageable pageable) {
  ...
  @ApiOperation(
    ...
    notes = "Update an existing skill. The connected user must be an admin.",
    response = Skill.class,
    authorizations = {
      @Authorization(value = "bearer", scopes = {
        @AuthorizationScope(scope = "admin", description = "Grants read and write access to anything (his/others contacts and their skills, skills, users).")
  ...
  default ResponseEntity<Skill> updateSkill(
    @ApiParam(value = "Name of the skill to update.", required = true) @PathVariable("name") String name,
